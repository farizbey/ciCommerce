<div class="row">
	...
	<div class="col-md-9">
		...
		<div class="media">
			<div class="media-left media-middle">
				<a href="<?php echo base_url() . 'blogs/display/' . $value->blog_id; ?>">
					<img class="media-object" src="<?php echo base_url(); ?>assets/images/<?php echo $value->blog_image_thumb; ?>" alt="..."/>
				</a>
			</div>
	...
	<div class="col-md-3 text-center">
		...
		<!-- <div class="col-sm-12 col-md-12 text-center"> -->
	    	<div class="thumbnail">
	      		<img src="<?php echo base_url(); ?>assets/images/<?php echo $value2->image_name_thumb; ?>" alt="..."/>
	      		<div class="caption">
	        		<a href="<?php echo base_url() . 'collections/display/' . $value2->collections_id; ?>"><h3><?php echo $value2->collections_title; ?></h3></a>
