...
<section class="portfolio">
	...
	?>
		<div class="col-sm-3 col-md-3 text-center">
	    	<div class="thumbnail">
	      		<img src="<?php echo base_url(); ?>assets/images/<?php echo $value->image_name_thumb; ?>" alt="..."/>
	      		<div class="caption">
	        		<a href="<?php echo base_url() . 'collections/display/' . $value->collections_id; ?>"><h3><?php echo $value->collections_title; ?></h3></a>
